  ...
  return (
    <main className="auth-shell">
      <section className="auth-card">
        ...
        <p className="auth-copy">ShiftTrack uses your Google account for authentication and sync across devices.</p>
        <div className="auth-form">
          {message && <div className="auth-message">{message}</div>}
          <button className="google-auth" onClick={signInWithGoogle} disabled={busy}><GoogleIcon /> {busy ? 'Opening Google...' : 'Log in with Google'}</button>
        </div>
      </section>
    </main>
  );
